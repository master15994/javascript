...
// const more5 = numbers.filter(a =>a >5);
// console.log (more5);

// const number = numbers.filter ( a => a > 10);
// console.log(number);

// const oddNumbers = numbers.filter( a=> a % 2===1);
...
// Создайте массив чисел. Используя метод filter(), выберите из массива только четные числа.
...
// console.log(filmsTes);
 ...
 // const filmsLens = movies.filter ((a ) => a.year = 2000);
// console.log(filmsLens);

// const filmsUnder1990= movies.filter((a) => a.year <1990);
// console.log(filmsUnder1990);

// const films1990 = movies.filter ((a ) => a.year > 1990);
// console.log(films1990);

// const films2000 = movies.filter ((a) => a.year > 2000);
